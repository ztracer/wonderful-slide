...
### Fixed
- Removed `CHANGELOG.md` from `.npmignore` to include it in published package

## [1.1.0] - 2026-06-14

### Added
- One-click skill installation via npx: `npx -y @traz1r/wonderful-slide`
- install.mjs script for automatic Claude Code skill setup
- install-skill npm script for manual installation
- Improved Quick Start section in README
